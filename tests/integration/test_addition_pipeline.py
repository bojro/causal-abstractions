...
from experiments.addition.metrics import metrics_from_logits
...
class AdditionPipelineIntegrationTests(unittest.TestCase):
    def test_problem_checks_and_pair_bank_determinism(self) -> None:
        ...
        self.assertEqual(bank_a.target_vars, ("S1", "C1", "S2", "C2"))
    ...
    def test_small_compare_pipeline(self) -> None:
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            gw_payload = run_alignment_pipeline(
                ...
                summarize_selection_records_fn=summarize_addition_selection_records,
                choose_better_selection_candidate_fn=choose_better_addition_candidate,
            )
        ...
        self.assertEqual(ot_payload["method_id"], "ot_current_res2_cosine")
        self.assertEqual(fgw_payload["method_id"], "fgw_current_res2_cosine_a0p5")
